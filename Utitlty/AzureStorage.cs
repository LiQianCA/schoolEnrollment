...
namespace schoolEnrollment.Utitlty
{
    public class AzureStorage : IAzureStorage
    {
        ...
        public AzureStorage()
        {
            _storageConnectionString = ConfigurationHelper.Instance.GetAppSetting("BlobConnectionString", "");
            _storageContainerName = ConfigurationHelper.Instance.GetAppSetting("BlobContainerName","");
        ...
        public async Task<BlobResponseDto> UploadAsync(byte[] bytes,string filename)
        {
            ...
            try
            {
                ...
                await using (Stream? data = new MemoryStream(bytes))
                {
